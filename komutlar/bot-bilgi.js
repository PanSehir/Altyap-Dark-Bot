...
module.exports.run = async(client, message, args) => {
  const duration = moment.duration(client.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]");
    ...
    .addField(`Discord.js sürümü:`, Discord.version)
      .addField(':spy: Yapımcım:', '<@540640047129427995> \n `PanSehir`')
      .addField(':paperclip: Botun Başlanma Zamanı:', "Bot **12.02.2019**'de yapılmaya başlanmıştır")
    .setFooter('DARK', client.user.avatarURL)
    .setTimestamp()
